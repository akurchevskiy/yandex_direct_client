...
# Unit tests for YandexDirectClient::Grand
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Grand' do
  before do
    # run before each test
    @instance = YandexDirectClient::Grand.new
  end
  ...
  describe 'test an instance of Grand' do
    it 'should create an instance of Grand' do
      expect(@instance).to be_instance_of(YandexDirectClient::Grand)
    end
  end
  describe 'test attribute "privilege"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["EDIT_CAMPAIGNS", "IMPORT_XLS", "TRANSFER_MONEY"])
