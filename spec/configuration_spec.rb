...
describe YandexDirectClient::Configuration do
  let(:config) { YandexDirectClient::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://api-sandbox.direct.yandex.com/json/v5")
    # YandexDirectClient.configure do |c|
    #   c.host = uri.host
  ...
  describe '#base_url' do
    it 'should have the default value' do
      ...
      # expect(config.base_url).to eq("https://api-sandbox.direct.yandex.com/json/v5")
    end
