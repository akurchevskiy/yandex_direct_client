...
require 'yandex_direct_client/models/campaigns'
...
require 'yandex_direct_client/models/campaigns_get_item_request_params_selection_criteria'
require 'yandex_direct_client/models/campaigns_get_item_request_params_page'
require 'yandex_direct_client/models/clients'
